...
class Defaults:
    def __init__(self, base_file_path=""):
        ...
        self.DEFAULT_MODEL_STORE_FILE_NAME = os.path.join(
            self.BASE_FILE_PATH, "file_metadata.json"
        )
        self.DEFAULT_NOTES_FILE_NAME = os.path.join(
        ...
        self.DEFAULT_SETTINGS_STORE_FILE_NAME = os.path.join(
            self.BASE_FILE_PATH, "settings.json"
        )
