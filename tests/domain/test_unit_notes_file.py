...
<section=second> Quis istum dolorem timet"""
    ...
    def test_section_separators_sorted(self, get_notes_file):
        assert all(
            [isinstance(x, str) for x in get_notes_file.section_separators_sorted]
        )
    ...
    def test_delete_section_content(self, get_notes_file):
        ...
        assert (
            get_notes_file.delete_section_content(section_separator="<section=a> ")
            is None
        )
...
<section=second> Quis istum dolorem timet"""
    ...
    def test_save_file_data_handle_error(self, get_app, get_notes_file):
        ...
        get_notes_file._data_by_sections = (
            get_notes_file._transform_raw_data_content_to_data_by_sections()
        )
